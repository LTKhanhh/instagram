...
import { faHome, faMagnifyingGlass, faFilm, faXmark } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <>
            ...
            <div className={cx('container', 'h-screen ')}>
                <div className={cx('logo')}>
                    <a>
                        <div className={cx('svg')}>
                            {/* <svg aria-label="Instagram" className="w-full h-full relative right-0" >
                ...
                <MenuItem openCreate={onOpen} icon={<img src={`${process.env.PUBLIC_URL}/square-plus-regular.svg`}></img>} text={'Tạo'} ></MenuItem>
